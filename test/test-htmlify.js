...
var linkifier = require('./helpers/linkifier.js')

test('Fake linkifier works', function (t) {
	t.equal(linkifier.linkify('test'), 'test')
	t.end()
})
...
test('Respects post.metadata.markdown field', function (t) {
	...
	var content1 = htmlify(linkifier, post1)
	...
	var content2 = htmlify(linkifier, post2)
	...
	var content3 = htmlify(linkifier, post3)
